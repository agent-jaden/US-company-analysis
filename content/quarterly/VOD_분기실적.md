...
> 생성일: 2026-05-06 | 출처: Alpha Vantage | 결산월: 3월 | 분기 기준: 캘린더 | 통화: EUR

**Communication Services | Telecom Services | 시총 36B$ (#417위) | 결산월: 3월**
...
Vodafone은 독일, 영국, 기타 유럽, 터키, 남아프리카에서 통신 서비스를 제공한다. 모바일·유선 서비스, IoT·디지털·금융 서비스를 포함한 기업 연결 솔루션, 클라우드·멀티클라우드·엣지 컴퓨팅, 아프리카 모바일 머니 플랫폼 M-PESA, 국제 음성·로밍 서비스를 운영한다.
